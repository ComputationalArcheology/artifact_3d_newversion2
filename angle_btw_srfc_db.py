...
class AngleBetweenSurfacesWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        form_layout.addRow("Max Width (h):", self.input_h)
        ...
        form_layout.addRow("Dilute Factor:", self.input_dilute)

        self.input_method = QComboBox()
        self.input_method.addItems(["Legacy (Mean Surfaces)", "New (Mean Angle)"])
        form_layout.addRow("Method:", self.input_method)
    ...
    def _calculate_angle(self):
        ...
        normals = self.mesh.cell_normals[::dil]
